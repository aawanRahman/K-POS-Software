 ...
 * @author Najmul
 */
public class input_asset extends javax.swing.JFrame {
   ...
   public void exit(){
    ...
    void show_products(){    
        ...
        try{
            ...
            String Query =("SELECT id AS ID, product_name AS 'Assets Name', quantity AS 'Quantity',price AS Ammount,type AS Type, issuer AS 'Issuer',date AS 'Date' FROM assets ORDER BY id desc");
            PreparedStatement statement = db.connect().prepareStatement(Query);
            ResultSet rs =statement.executeQuery(Query);
    ...
    private void initComponents() {
        ...
        product_name.setToolTipText("Asset Name");
        ...
        selected_item.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cash on Hand", "Cash on Bank", "Equipment", "Others" }));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(price)
                                .addComponent(product_name, javax.swing.GroupLayout.DEFAULT_SIZE, 281, Short.MAX_VALUE)
                                .addComponent(qty, javax.swing.GroupLayout.DEFAULT_SIZE, 281, Short.MAX_VALUE)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(notification_product, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            PreparedStatement pst = db.connect().prepareStatement("INSERT INTO assets (product_name ,price,quantity,about,issuer,date,type)" + "VALUES (?,?,?,?,?,?,?)");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(products.getSelectionModel().isSelectionEmpty()){
            ...
            try{ 
                PreparedStatement pst = db.connect().prepareStatement("UPDATE assets SET product_name=?,price=?,quantity=?,about=?,issuer=?,date=?,type=? WHERE id='"+Table_Click+"' ");
                pst.setString(1, Product_Name);
                pst.setString(2, Price);
                pst.setString(3, Quantity);
                pst.setString(4, About);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(User_Type.equals("Yes") || Delete_Access.equals("Yes")){
            ...
            JOptionPane.showMessageDialog(this, "Please Select a Product First","Error", JOptionPane.QUESTION_MESSAGE);
                ...
                String Table_Click = (products.getModel().getValueAt(row,0).toString());
                try{ 
                    PreparedStatement pst = db.connect().prepareStatement("DELETE FROM Assets WHERE id='"+Table_Click+"' ");             
                    pst.execute(); 
                    notification_product.setText("Asset Deleted !"); 
                    clear();
                }
                catch(Exception e){
                    System.out.println("My Sql is Not Running : "+e);
    ...
    private void search(){
        ...
        if(Product_Name.isEmpty()){
           show_products();
            ...
            try{
             String Query =("SELECT id AS ID, product_name AS 'Assets Name', quantity AS 'Quantity',price AS Ammount , type AS Type , issuer AS 'Issuer',date AS 'Date' FROM assets WHERE product_name LIKE '%"+Product_Name+"%' OR id LIKE '%"+Product_Name+"%'");
             PreparedStatement statement = db.connect().prepareStatement(Query);
             ResultSet rs =statement.executeQuery(Query);
             products.setModel(DbUtils.resultSetToTableModel(rs));
           }
    ...
    private void productsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_productsMouseClicked
        ...
        try{
            int row = products.getSelectedRow();
            String Table_Click = (products.getModel().getValueAt(row,0).toString());
            String Query ="SELECT * FROM assets WHERE id='"+Table_Click+"'";           
            PreparedStatement statement = db.connect().prepareStatement(Query);
            ResultSet rs =statement.executeQuery(Query);
            if(rs.next()){
                ...
                selected_item.setSelectedItem(add6);  
            }
        }
        catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(input_asset.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new input_asset().setVisible(true);
            }
        });
    }
