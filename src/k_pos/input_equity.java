 ...
 * @author Najmul
 */
public class input_equity extends javax.swing.JFrame {
    ...
    void show_owners_equity(){    
        products.getTableHeader().setEnabled(false);
        products.getTableHeader().setFont(new Font("Tahoma",Font.PLAIN,17));
        try{
            //id,Name,Price,Quantity
            String Query =("SELECT id AS ID, product_name AS ' Name', quantity AS 'Quantity',price AS Ammount ,type AS Type, issuer AS 'Issuer',date AS 'Date' FROM liability_equity ORDER BY id desc");
            PreparedStatement statement = db.connect().prepareStatement(Query);
            ResultSet rs =statement.executeQuery(Query);
    ...
    private void initComponents() {
        ...
        selecteditem = new javax.swing.JComboBox<>();
        ...
        price.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(195, 195, 195), 1, true));
        ...
        selecteditem.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Note Payable", "Others" }));
        selecteditem.setToolTipText("");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(price)
                                    .addComponent(product_name, javax.swing.GroupLayout.DEFAULT_SIZE, 283, Short.MAX_VALUE)
                                    .addComponent(qty, javax.swing.GroupLayout.DEFAULT_SIZE, 283, Short.MAX_VALUE)
                                    .addComponent(jScrollPane2)
                                    .addComponent(selecteditem, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(notification_product, javax.swing.GroupLayout.PREFERRED_SIZE, 330, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(5, 5, 5)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(get_product_name, javax.swing.GroupLayout.DEFAULT_SIZE, 403, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(10, 10, 10)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(selecteditem, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel13))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String Selected_Item = String.valueOf(selecteditem.getSelectedItem());
        ...
        try{
            PreparedStatement pst = db.connect().prepareStatement("INSERT INTO liability_equity (product_name ,price,quantity,about,issuer,date,type)" + "VALUES (?,?,?,?,?,?,?)");
            ...
            pst.setString(7, Selected_Item);           
            pst.executeUpdate();     
            notification_product.setText("Assets Successfully Added ! "); 
            clear();
        }
        catch(Exception e){
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(products.getSelectionModel().isSelectionEmpty()){
            ...
            try{ 
                PreparedStatement pst = db.connect().prepareStatement("UPDATE liability_equity SET product_name=?,price=?,quantity=?,about=?,issuer=?,date=?,type=? WHERE id='"+Table_Click+"' ");
                pst.setString(1, Product_Name);
                pst.setString(2, Price);
                pst.setString(3, Quantity);
                pst.setString(4, About);
                ...
                pst.setString(7, Selected_Item);           
                pst.executeUpdate(); 
                notification_product.setText("Assets Updated !");             
                clear();
            }
            catch(Exception e){
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(User_Type.equals("Yes") || Delete_Access.equals("Yes")){
            ...
            JOptionPane.showMessageDialog(this, "Please Select a Product First","Error", JOptionPane.QUESTION_MESSAGE);
                ...
                String Table_Click = (products.getModel().getValueAt(row,0).toString());
                try{ 
                    PreparedStatement pst = db.connect().prepareStatement("DELETE FROM liability_equity WHERE id='"+Table_Click+"' ");             
                    pst.execute(); 
                    notification_product.setText("Owner's Equity Deleted !");  
                    clear();
                }
                catch(Exception e){
                    System.out.println("My Sql is Not Running : "+e);
    ...
    private void search(){
        ...
        if(Product_Name.isEmpty()){
           show_owners_equity();
            ...
            try{
             String Query =("SELECT id AS ID, product_name AS 'Name', quantity AS 'Quantity',price AS Ammount ,type AS Type, issuer AS 'Issuer',date AS 'Date' FROM liability_equity WHERE product_name LIKE '%"+Product_Name+"%' OR id LIKE '%"+Product_Name+"%'");
             PreparedStatement statement = db.connect().prepareStatement(Query);
             ResultSet rs =statement.executeQuery(Query);
             products.setModel(DbUtils.resultSetToTableModel(rs));
           }
    ...
    private void productsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_productsMouseClicked
        ...
        try{
            int row = products.getSelectedRow();
            String Table_Click = (products.getModel().getValueAt(row,0).toString());
            String Query ="SELECT * FROM liability_equity WHERE id='"+Table_Click+"'";           
            PreparedStatement statement = db.connect().prepareStatement(Query);
            ResultSet rs =statement.executeQuery(Query);
            if(rs.next()){
                ...
                selecteditem.setSelectedItem(add6);  
            }
        }
        catch(Exception e){
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        account_report ip= new account_report();
        ip.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(input_equity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new input_equity().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> selecteditem;
