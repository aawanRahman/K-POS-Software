 ...
 * @author Najmul
 */
public class input_refill extends javax.swing.JFrame {
   ...
   public void exit(){
    ...
    void show_products(){    
        ...
        try{
           ...
           String Query =("SELECT id AS ID, product_name AS 'Product Name', price AS 'Price',company AS 'Company',Issuer, date AS 'Date' FROM refill ORDER BY id desc LIMIT 100");
           PreparedStatement statement = db.connect().prepareStatement(Query);
           ResultSet rs =statement.executeQuery(Query);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add New Refill Product");
        ...
        company.setToolTipText("Quantity");
        ...
        jLabel2.setText("* Price Will Always be an Negative Value.");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(product_name, javax.swing.GroupLayout.DEFAULT_SIZE, 298, Short.MAX_VALUE))
                    ...
                    .addComponent(company, javax.swing.GroupLayout.PREFERRED_SIZE, 298, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(10, 10, 10)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(Product_Name.isEmpty() || Price.isEmpty() || Company.isEmpty()){
            ...
            try{
                ...
                if (Number < 0) {
                    PreparedStatement pst = db.connect().prepareStatement("INSERT INTO refill (product_name , price , company , date,Issuer)" + "VALUES (?,?,?,?,?)");
                   ...
                   JOptionPane.showMessageDialog(null, "Price must be a Negative Number. !");
                }
            }
            catch(Exception e){
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(products.getSelectionModel().isSelectionEmpty()){
            ...
            if(Product_Name.isEmpty() || Price.isEmpty() || Company.isEmpty()){
                ...
                try{ 
                    PreparedStatement pst = db.connect().prepareStatement("UPDATE refill SET product_name=?,price=?,company=?,Issuer=?,date=? WHERE id='"+Table_Click+"' ");
                    pst.setString(1, Product_Name);
                    pst.setString(2, Price);
                    pst.setString(3, Company);
                    pst.setString(4, Issuer);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(User_Type.equals("Yes") || Delete_Access.equals("Yes")){
            ...
            JOptionPane.showMessageDialog(this, "Please Select a Product First","Error", JOptionPane.QUESTION_MESSAGE);
                ...
                String Table_Click = (products.getModel().getValueAt(row,0).toString());
                try{ 
                    PreparedStatement pst = db.connect().prepareStatement("DELETE FROM refill WHERE id='"+Table_Click+"' ");             
                    pst.execute(); 
    ...
    private void search(){
        ...
        if(Product_Name.isEmpty()){
           show_products();
            ...
            try{
                String Query =("SELECT id AS ID, product_name AS 'Product Name', price AS 'Price',company AS 'Company',Issuer, date AS 'Date' FROM refill WHERE product_name LIKE '%"+Product_Name+"%' OR id LIKE '%"+Product_Name+"%'");
                PreparedStatement statement = db.connect().prepareStatement(Query);
                ResultSet rs =statement.executeQuery(Query);
                products.setModel(DbUtils.resultSetToTableModel(rs));
           }
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        input_refill_storage rs = new input_refill_storage();
        rs.setVisible(true);
        this.dispose();        
    }//GEN-LAST:event_jButton9ActionPerformed

    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        //Show all Refill Products
        show_products();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(input_refill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new input_refill().setVisible(true);
            }
        });
    }
