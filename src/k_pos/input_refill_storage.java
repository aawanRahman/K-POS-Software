 ...
 * @author Najmul
 */
public class input_refill_storage extends javax.swing.JFrame {
    db_connect db = new db_connect();
    
    /**
     * Creates new form homepage
     */
    public input_refill_storage() {
        full_screen();   
        initComponents();
   ...
   public void exit(){
    ...
    //Refill Product Show For Delete
    public void show_refill_item(){        
        products.getTableHeader().setFont(new Font("Tahoma",Font.PLAIN,17));
        try{
           String Query =("SELECT id AS ID , Product AS 'Product Name' , Quantity , Price , Total_Price AS 'Total Price' , Date FROM sold_report WHERE Issuer = 'Refill' ORDER BY id DESC");
           PreparedStatement statement = db.connect().prepareStatement(Query);
           ResultSet rs =statement.executeQuery(Query);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(notification_product, javax.swing.GroupLayout.DEFAULT_SIZE, 291, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(Product_Name.isEmpty() || Price.isEmpty() || Quantity.isEmpty()){
            JOptionPane.showMessageDialog(null, "Please Fill Up All Input Field.", "Alert", JOptionPane.PLAIN_MESSAGE);
        }
        else{
            double val1 = Double.parseDouble(Price);
            double val2 = Double.parseDouble(Quantity);
            ...
            try{
                ...
                if (Number < 0) {
                   try{
                        PreparedStatement pst = db.connect().prepareStatement("INSERT INTO sold_report (Product , Quantity , Price , Total_Price , Issuer , Date)" + "VALUES (?,?,?,?,?,?)");
                        ...
                        pst.executeUpdate();     
                        notification_product.setText("Refill Successfully Added ! "); 
                        clear();
                    }
                    catch(Exception e){
                ...
                System.out.println("Error with Negative Number. "+e);
            }            
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(products.getSelectionModel().isSelectionEmpty()){
            ...
            if(Product_Name.isEmpty() || Price.isEmpty() || Quantity.isEmpty()){
                ...
                try{ 
                    PreparedStatement pst = db.connect().prepareStatement("UPDATE sold_report SET Product=?,Quantity=?,Price=?,Total_Price=?,Issuer=?,Date=? WHERE id='"+Table_Click+"' ");
                    pst.setString(1, Product_Name);
                    pst.setString(2, Quantity);
                    pst.setString(3, Price);
                    pst.setString(4, Total_Price);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(User_Type.equals("Yes") || Delete_Access.equals("Yes")){
            if(products.getSelectionModel().isSelectionEmpty()){
                ...
                String Table_Click = (products.getModel().getValueAt(row,0).toString());
                try{ 
                    PreparedStatement pst = db.connect().prepareStatement("DELETE FROM sold_report WHERE id='"+Table_Click+"' ");             
                    pst.execute(); 
    ...
    private void search(){
        ...
        if(Product_Name.isEmpty()){
           show_refill_item();
            ...
            try{
             String Query =("SELECT id AS ID ,Product AS 'Product Name', Quantity , Price , Total_Price AS 'Total Price' , Date FROM sold_report WHERE Product LIKE '%"+Product_Name+"%'");
             PreparedStatement statement = db.connect().prepareStatement(Query);
             ResultSet rs =statement.executeQuery(Query);
             products.setModel(DbUtils.resultSetToTableModel(rs));
           }
    ...
    private void productsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_productsMouseClicked
        ...
        try{
            int row = products.getSelectedRow();
            String Table_Click = (products.getModel().getValueAt(row,0).toString());
            String Query ="SELECT * FROM sold_report WHERE id='"+Table_Click+"'";           
            PreparedStatement statement = db.connect().prepareStatement(Query);
            ResultSet rs =statement.executeQuery(Query);
            if(rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(input_refill_storage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new input_refill_storage().setVisible(true);
            }
        });
    }
