...
public void exit(){
    ...
    void show_due_products(){
        products.getTableHeader().setEnabled(false);
        products.getTableHeader().setFont(new Font("Tahoma",Font.PLAIN,17));
        try{
            //id,Name,Price,Quantity
           String Query =("SELECT id AS ID,username AS 'Customer Name',mobile AS Mobile,due AS Due  FROM customers WHERE due>0 ORDER BY id desc");
           PreparedStatement statement = db.connect().prepareStatement(Query);
           ResultSet rs =statement.executeQuery(Query);
    ...
    private void initComponents() {
        ...
        get_due_product_name = new javax.swing.JTextField();
        ...
        user_name.setToolTipText("Product Name");
        user_name.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(195, 195, 195), 1, true));

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setText("Get Due Ammount");

        due.setEditable(false);
        due.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        due.setText(" Due");
        due.setToolTipText("Due");
        ...
        get_due_product_name.setFont(new java.awt.Font("Tahoma", 0, 17)); // NOI18N
        get_due_product_name.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        get_due_product_name.setToolTipText("Search by Customer Name or Mobile No");
        get_due_product_name.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true));
        get_due_product_name.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                get_due_product_nameKeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                get_due_product_nameKeyTyped(evt);
            }
        });
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/k_pos/images/Get_due_amount.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(notification_product, javax.swing.GroupLayout.PREFERRED_SIZE, 242, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(user_name, javax.swing.GroupLayout.DEFAULT_SIZE, 312, Short.MAX_VALUE)
                    .addComponent(due)
                    .addComponent(paid))
                .addGap(10, 10, 10)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(get_due_product_name)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(get_due_product_name, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(notification_product, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if(products.getSelectionModel().isSelectionEmpty()){
            ...
            double due_double = Double.parseDouble(Due);
            double paid_double = Double.parseDouble(Paid);            
            double final_double = due_double-paid_double;            
            String Final = new Double(final_double).toString();
            ...
            try{ 
                PreparedStatement pst = db.connect().prepareStatement("UPDATE customers SET username=?,due=?,Expected_Payment_Date=? WHERE id='"+Table_Click+"' ");
                pst.setString(1, User_Name);
                pst.setString(2, Final);
                pst.setString(3, Date);               
                pst.executeUpdate(); 
                notification_product.setText("Due Updated !");   
                 try{                      
                    PreparedStatement insert_due_report = db.connect().prepareStatement("INSERT INTO due_report (Username , Total_Due, Paid ,Due, Issuer , Date)" + "VALUES (?,?,?,?,?,?)");
                    insert_due_report.setString(1, User_Name);
                    insert_due_report.setString(2, Due);
                    insert_due_report.setString(3, Paid);
                    insert_due_report.setString(4, Final);
                    insert_due_report.setString(5, Issuer);
                    insert_due_report.setString(6, Date);
                    insert_due_report.executeUpdate();
                }
                catch(Exception e){
                    System.out.println("Error With Sql.: "+e);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if(products.getSelectionModel().isSelectionEmpty()){
            ...
            String Table_Click = (products.getModel().getValueAt(row,0).toString());
            try{ 
                PreparedStatement pst = db.connect().prepareStatement("DELETE FROM sold WHERE id='"+Table_Click+"' ");             
                pst.execute(); 
                notification_product.setText("Due Product Deleted !");              
            }
            catch(Exception e){
                System.out.println("My Sql is Not Running : "+e);
                notification_product.setText("Error !"); 
    ...
    private void search(){
        String Product_Name = get_due_product_name.getText();
        LocalDate localDate = LocalDate.now();//For reference
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
        String Date = localDate.format(formatter);
        if(Product_Name.isEmpty()){
           show_due_products();
            ...
            try{
             String Query =("SELECT id AS ID,username AS 'Customer Name',mobile AS Mobile,due AS Due FROM customers WHERE username LIKE '%"+Product_Name+"%' OR mobile LIKE '%"+Product_Name+"%' ORDER BY id desc ");
             PreparedStatement statement = db.connect().prepareStatement(Query);
             ResultSet rs =statement.executeQuery(Query);
             products.setModel(DbUtils.resultSetToTableModel(rs));
           }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            PreparedStatement pst = db.connect().prepareStatement("INSERT INTO sold (Username, Total_Price, Paid, Payment, Date)" + "VALUES (?,?,?,?,?)");
            pst.setString(1, User_Name);
            pst.setString(2, Price);
            pst.setString(3, Paid);
            pst.setString(5, Date);
            pst.executeUpdate();
            notification_product.setText("Due Successfully Added ! ");
        }
        catch(Exception e){
    ...
    private void get_due_product_nameKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_get_due_product_nameKeyPressed
       // Enter Key Pressed Search
         if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            search ();
        }
    }//GEN-LAST:event_get_due_product_nameKeyPressed

    private void get_due_product_nameKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_get_due_product_nameKeyTyped
        //Key Typed 
        search ();
    }//GEN-LAST:event_get_due_product_nameKeyTyped
    ...
    private javax.swing.JTextField get_due_product_name;
